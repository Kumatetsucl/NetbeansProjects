...
public class DaoEmpleado {
    ...
    public ArrayList<Empleado> Listar() {
        try {
            ...
            while (reg.next()) {
                ...
                pers.setNacionalidad(reg.getString("GENERO_CLIENTE"));
                listado.add(pers);
            }
            return listado;
        } catch (Exception e) {
    ...
    public boolean Grabar(Empleado usuario) {
        try {
            if (VerificaExistente(usuario.getRut(), usuario.getIdCliente())) {
                ...
                pstm.setString(5, usuario.getNacionalidad());
    ...
    public Empleado Buscar2(int idcliente) {
        try {
